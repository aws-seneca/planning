...
| `planning/sessions/2026-fall/2026-10-07-aws-101/app/` | Git-ignored here. Public repo `aws-seneca/aws-101-workshop`: Next.js waitlist page and organizer table attendees clone onto EC2. Stores sign-ups in a local JSON file until `.env` has `DATABASE_URL` (RDS). Attendee steps: `app/WORKSHOP.md` | When working on the Event 2 app or challenge |
...
| `planning/sessions/2026-fall/2026-10-07-aws-101/README.md` | **Event 2 plan of record**: run of show, account options, pre-event email, checklist, dates, open questions. Consolidated on 2026-09-24 from the Sep 13 notes and the Sep 18 runbook (both in git history) | When working on Event 2 |
