...
| # | Task | Owner | Due | Status | Source |
|---|---|---|---|---|---|
| 6 | Draft the Event 2 workshop plan as notes (not slides) | davedat. | Not set, "take ur time," but Oct 7 makes the week of Sep 15 the real deadline | **Drafted 2026-09-13.** Awaiting Daksh review, see `planning/sessions/2026-fall/2026-10-07-aws-101/workshop-notes.md` | 2026-09-10 18:03 (asked), 2026-09-13 11:23 (scope confirmed as notes) |
...
| 6f | Decide whether CI/CD moves from master-plan Event 6 (Q3) into the fall, and whether it takes **both** Oct 28 and Nov 18 | Bilal | Week of Sep 22 | Proposed 2026-09-13, see the CI/CD proposal (in git history, `events/cicd-track/` at `df72b74`). Scoped as two sessions. Events 3 and 4 currently have no topic at all | 2026-09-13 |
...
| 6h | Build the CI/CD template repository and CloudFormation stack | Unassigned | Start Sep 17 if approved | Spec written 2026-09-13, in git history: `events/cicd-track/` in commit `df72b74` (removed from the folder 2026-09-24). Nothing has been run yet | 2026-09-13 |
