...
| **Study guide** | [study-guide/](../../study-guide/README.md), public repo `aws-seneca/aws-101-official-tutorial`, live at https://aws-seneca.github.io/aws-101-official-tutorial/. This workshop is its Lesson 2; Lesson 1 is AWS's official PHP tutorial |
...
An alternative plan built on AWS's official PHP tutorial was not chosen. That tutorial is now Lesson 1 of the club's study notes, with its runbook in [study-guide/](../../study-guide/README.md).
